...
function refreshDefaultCharacter()
	...
	if GetEntityModel(PlayerPedId()) == GetHashKey("mp_m_freemode_01") then
        ...
        SetPedComponentVariation(PlayerPedId(),4,26,3,2)
        ...
        SetPedComponentVariation(PlayerPedId(),11,313,0,2)
		...
		SetPedComponentVariation(PlayerPedId(),11,280,0,2)
...
RegisterNUICallback('cDone',function(data,cb)
	...
	TriggerServerEvent("character:updateName", data.nome, data.sobrenome, data.idade)
end)
...
RegisterNUICallback('UpdateSkinOptions',function(data,cb)
	idNome = data.characterNome
	idSobrenome = data.characterSobrenome
	idIdade = data.characterAge
