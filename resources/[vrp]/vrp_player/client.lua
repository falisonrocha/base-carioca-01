...
Citizen.CreateThread(function()
	while true do
    	...
    	SetDiscordAppId(1279935395953639496)
		SetDiscordRichPresenceAssetText('discord.gg/baixadarj ['..uid..']')
		SetDiscordRichPresenceAsset("logo")
		SetRichPresence("Jogadores Conectados: "..players)
		SetDiscordRichPresenceAction(0, "JOGAR", "fivem://connect/cfx.re/join/3lpdlz")
		SetDiscordRichPresenceAction(1, "DISCORD", "https://discord.gg/baixadarj")
...
RegisterCommand("attachs",function(source,args)
    ...
    if vSERVER.checkAttachs() then
		...
		elseif GetSelectedPedWeapon(ped) == GetHashKey("WEAPON_AR10BXD") then
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_AR10BXD"),GetHashKey("COMPONENT_CARBINERIFLEAR10BXD_CLIP_02"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_AR10BXD"),GetHashKey("COMPONENT_AT_AR_AFGRIPAR10BXD"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_AR10BXD"),GetHashKey("COMPONENT_AT_SCOPE_MEDIUMAR10BXD"))
		elseif GetSelectedPedWeapon(ped) == GetHashKey("WEAPON_ARREALBXD") then
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_ARREALBXD"),GetHashKey("COMPONENT_CARBINERIFLEREALBXD_CLIP_02"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_ARREALBXD"),GetHashKey("COMPONENT_AT_AR_AFGRIPREALBXD"))
		elseif GetSelectedPedWeapon(ped) == GetHashKey("WEAPON_M16PCC") then
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_M16PCC"),GetHashKey("COMPONENT_CARBINERIFLEM16PCC_CLIP_02"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_M16PCC"),GetHashKey("COMPONENT_AT_AR_AFGRIPM16PCC"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_M16PCC"),GetHashKey("COMPONENT_AT_AR_FLSH_REH"))
		elseif GetSelectedPedWeapon(ped) == GetHashKey("WEAPON_UMPPCC") then
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_UMPPCC"),GetHashKey("COMPONENT_SMGUMPPCC_CLIP_02"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_UMPPCC"),GetHashKey("COMPONENT_AT_SCOPE_MACROUMPPCC"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_UMPPCC"),GetHashKey("COMPONENT_AT_AR_FLSH"))
		elseif GetSelectedPedWeapon(ped) == GetHashKey("WEAPON_FALLGROTA") then
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_FALLGROTA"),GetHashKey("COMPONENT_AT_AR_SUPPGRT_02"))
		...
		elseif GetSelectedPedWeapon(ped) == GetHashKey("WEAPON_ARTAMBOR100") then
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_ARTAMBOR100"),GetHashKey("COMPONENT_CARBINERIFLEARTAMBOR_CLIP_02"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_ARTAMBOR100"),GetHashKey("COMPONENT_AT_AR_AFGRIPTAMBOR"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_ARTAMBOR100"),GetHashKey("COMPONENT_AT_SCOPE_MEDIUMARTAMBOR"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_ARTAMBOR100"),GetHashKey("COMPONENT_AT_AR_FLSHARTAMBOR"))
		elseif GetSelectedPedWeapon(ped) == GetHashKey("WEAPON_MCX") then
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_MCX"),GetHashKey("COMPONENT_CARBINERIFLEM4B_CLIP_02"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_MCX"),GetHashKey("COMPONENT_AT_AR_SUPPM4B"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_MCX"),GetHashKey("COMPONENT_AT_AR_AFGRIPM4B"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_MCX"),GetHashKey("COMPONENT_AT_AR_FLSHM4B"))
		elseif GetSelectedPedWeapon(ped) == GetHashKey("WEAPON_ARCV2") then
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_ARCV2"),GetHashKey("COMPONENT_CARBINERIFLEARCV2_CLIP_02"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_ARCV2"),GetHashKey("COMPONENT_AT_SCOPE_MEDIUMARCV2"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_ARCV2"),GetHashKey("COMPONENT_AT_AR_FLSHARCV2"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_ARCV2"),GetHashKey("COMPONENT_AT_AR_AFGRIPARCV2"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_ARCV2"),GetHashKey("COMPONENT_AT_MUZZLE_01"))
		elseif GetSelectedPedWeapon(ped) == GetHashKey("WEAPON_ARCROACIA") then
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_ARCROACIA"),GetHashKey("COMPONENT_CARBINERIFLEARCROACIA_CLIP_02"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_ARCROACIA"),GetHashKey("COMPONENT_AT_AR_AFGRIPARCROACIA"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_ARCROACIA"),GetHashKey("COMPONENT_AT_SCOPE_MEDIUMARCROACIA"))
		elseif GetSelectedPedWeapon(ped) == GetHashKey("WEAPON_MTARGROTA") then
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_MTARGROTA"),GetHashKey("COMPONENT_ASSAULTSMGGROTA_CLIP_02"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_MTARGROTA"),GetHashKey("COMPONENT_AT_AR_FLSH"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_MTARGROTA"),GetHashKey("COMPONENT_AT_SCOPE_MACRO"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_MTARGROTA"),GetHashKey("COMPONENT_AT_AR_SUPP_02"))
		elseif GetSelectedPedWeapon(ped) == GetHashKey("WEAPON_HK417DENDE") then
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_HK417DENDE"),GetHashKey("COMPONENT_AT_SCOPE_MEDIUMHK417DENDE"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_HK417DENDE"),GetHashKey("COMPONENT_AT_AR_FLSHHK417DENDE"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_HK417DENDE"),GetHashKey("COMPONENT_AT_AR_AFGRIPHK417DENDE"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_HK417DENDE"),GetHashKey("COMPONENT_CARBINERIFLEHK417DENDE_CLIP_02"))
		elseif GetSelectedPedWeapon(ped) == GetHashKey("WEAPON_SCARCIVIL") then
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_SCARCIVIL"),GetHashKey("COMPONENT_AT_SCOPE_MEDIUMSCARCIVIL"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_SCARCIVIL"),GetHashKey("COMPONENT_AT_AR_SUPPSCARCIVIL_02"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_SCARCIVIL"),GetHashKey("COMPONENT_SPECIALCARBINESCARCIVIL_CLIP_02"))
		elseif GetSelectedPedWeapon(ped) == GetHashKey("WEAPON_G3WHITE") then
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_G3WHITE"),GetHashKey("COMPONENT_SPECIALCARBINEG3WHITE_CLIP_02"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_G3WHITE"),GetHashKey("COMPONENT_AT_AR_AFGRIPG3WHITE"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_G3WHITE"),GetHashKey("COMPONENT_AT_AR_SUPPG3WHITE_02"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_G3WHITE"),GetHashKey("COMPONENT_AT_SCOPE_MEDIUMG3WHITE"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_G3WHITE"),GetHashKey("COMPONENT_AT_AR_FLSHG3WHITE"))
		elseif GetSelectedPedWeapon(ped) == GetHashKey("WEAPON_ARFRANCA") then
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_ARFRANCA"),GetHashKey("COMPONENT_CARBINERIFLEARFRANCA_CLIP_02"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_ARFRANCA"),GetHashKey("COMPONENT_AT_AR_SUPPARFRANCA"))
			GiveWeaponComponentToPed(ped,GetHashKey("WEAPON_ARFRANCA"),GetHashKey("COMPONENT_AT_SCOPE_MEDIUMARFRANCA"))
		end
    end
end)
...
--NPC DAS LOJAS--
local pedlist = {
	{ ['coords'] = vec4(77.38,-1387.68,29.38,178.121), ['hash'] = 0xC7496729, ['hash2'] = "a_f_y_runner_01"},
    { ['coords'] = vec4(-1632.1,-1015.49,13.13,319.81), ['hash'] = 0x8D8F1B10, ['hash2'] = "s_m_y_swat_01"},
    { ['coords'] = vec4(-506.87,292.45,83.39,174.17), ['hash'] = 0x4117D39B, ['hash2'] = "s_m_m_scientist_01"},
    { ['coords'] = vec4(92.89,-231.3,54.66,339.42), ['hash'] = 0x4117D39B, ['hash2'] = "s_m_m_scientist_01"},
    { ['coords'] = vec4(-177.75,6384.28,31.49,229.94), ['hash'] = 0x4117D39B, ['hash2'] = "s_m_m_scientist_01"},
    { ['coords'] = vec4(317.42,-1078.41,29.47,2.02), ['hash'] = 0x4117D39B, ['hash2'] = "s_m_m_scientist_01"},

    { ['coords'] = vec4(-616.99,-2366.09,13.95,325.7), ['hash'] = 0x441405EC, ['hash2'] = "s_m_y_xmech_01"},
    { ['coords'] = vec4(-621.69,-2363.57,13.95,332.9), ['hash'] = 0x5E3DA4A4, ['hash2'] = "s_m_y_cop_01"},
    { ['coords'] = vec4(-626.32,-2360.76,13.95,330.56), ['hash'] = 0xD47303AC, ['hash2'] = "s_m_m_doctor_01"},
    { ['coords'] = vec4(-631.3,-2357.72,13.95,327.18), ['hash'] = 0xB6B1EDA8, ['hash2'] = "s_m_y_fireman_01"},
    { ['coords'] = vec4(1148.26,-184.64,62.51,330.86), ['hash'] = 0x8D8F1B10, ['hash2'] = "s_m_y_swat_01"},
    { ['coords'] = vec4(-1746.84,-77.63,85.61,132.21), ['hash'] = 0x8D8F1B10, ['hash2'] = "s_m_y_swat_01"},
    { ['coords'] = vec4(914.7,350.14,110.67,54.24), ['hash'] = 0x8D8F1B10, ['hash2'] = "s_m_y_swat_01"},
    { ['coords'] = vec4(156.15,-934.82,29.98,189.5), ['hash'] = 0x8D8F1B10, ['hash2'] = "s_m_y_swat_01"},
    { ['coords'] = vec4(693.28,-298.28,59.31,264.07), ['hash'] = 0x8D8F1B10, ['hash2'] = "s_m_y_swat_01"},
    { ['coords'] = vec4(-853.09,-2169.16,8.95,216.15), ['hash'] = 0xD47303AC, ['hash2'] = "s_m_m_doctor_01"},
    { ['coords'] = vec4(-813.67,-1233.62,6.86,316.25), ['hash'] = 0x625D6958, ['hash2'] = "s_m_m_ciasec_01"},
    { ['coords'] = vec4(-425.6,1109.32,327.68,342.79), ['hash'] = 0x625D6958, ['hash2'] = "s_m_m_ciasec_01"},

    { ['coords'] = vec4(548.91,863.0,219.7,309.67), ['hash'] = 0x8D8F1B10, ['hash2'] = "s_m_y_swat_01"},
    { ['coords'] = vec4(-981.09,-1487.31,5.58,128.39), ['hash'] = 0x8D8F1B10, ['hash2'] = "s_m_y_swat_01"},
	{ ['coords'] = vec4(966.39,-120.09,74.36,223.8), ['hash'] = 0x8D8F1B10, ['hash2'] = "s_m_y_swat_01"},
	{ ['coords'] = vec4(-1086.29,-849.95,4.89,293.74), ['hash'] = 0x8D8F1B10, ['hash2'] = "s_m_y_swat_01"},

	{ ['coords'] = vec4(3080.33,-4746.38,6.07,101.1), ['hash'] = 0x6CCFE08A, ['hash2'] = "ig_clay"},
		...
		for k,v in pairs(showMe) do
			...
			if distance <= 5 then
				...
				if HasEntityClearLosToEntity(ped,k,17) then
					showMe3D(coordsMe.x,coordsMe.y,coordsMe.z+1.0,string.upper(v[1]),v[3],v[4],v[5],v[6])
				end
			end
		end
