...
AddEventHandler("vehtuning",function(vehicle)
	...
	if IsEntityAVehicle(vehicle) then
		...
		SetVehicleTyreSmokeColor(vehicle,0,255,140)
		SetVehicleWindowTint(vehicle,1)
		SetVehicleTyresCanBurst(vehicle,false)
		SetVehicleNumberPlateText(vehicle,"NATGROUP")
		SetVehicleNumberPlateTextIndex(vehicle,5)
		SetVehicleModColor_1(vehicle,241,101,7) ---------------------------241, 101, 7
		SetVehicleModColor_2(vehicle,241,101)
		SetVehicleColours(vehicle,241,101)
...
-- PLACA MERCOSUL
----------------------------------------------------------------------------------------------------------------------------------------
imageUrl = "https://cdn.discordapp.com/attachments/863882646559916052/1018142404374708264/EHx9638.png" -- 
