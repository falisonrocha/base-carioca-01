...
local locations = {
	...
	{ coords = vec3(1028.41,-2519.31,28.34), range = 10.0, permission = "perm.desmanche" }, -- motoclub
	{ coords = vec3(92.54,-1963.43,20.74), range = 10.0, permission = "perm.desmanche" }, -- roxos
	{ coords = vec3(730.04,-1088.78,22.16), range = 10.0, permission = "perm.desmanche" }, -- lacoste
	{ coords = vec3(-213.99,-1330.5,30.9), range = 10.0, permission = "perm.desmanche" }, -- bennys
	{ coords = vec3(1515.62,-2099.09,76.8), range = 50.0, permission = "perm.desmanche" }, -- pedreira
	{ coords = vec3(-1140.23,-1689.27,4.75), range = 10.0, permission = "perm.baucdd" }, -- cdd
	{ coords = vec3(992.13,-144.67,74.12), range = 10.0, permission = "perm.desmanche" }, -- motoclub
	{ coords = vec3(-1551.82,-394.2,41.97), range = 10.0, permission = "perm.desmanche" }, -- cohab
	{ coords = vec3(-583.71,317.5,84.89), range = 10.0, permission = "perm.desmanche" }, -- VK
	{ coords = vec3(-549.56,334.66,84.37), range = 10.0, permission = "perm.desmanche" }, -- VK
	{ coords = vec3(-348.36,-1532.38,27.7), range = 10.0, permission = "perm.desmanche" }, -- GRECIA
	{ coords = vec3(-720.68,-786.03,33.04), range = 10.0, permission = "perm.desmanche" }, -- CUSTOMS
	{ coords = vec3(-555.11,336.48,84.37), range = 10.0, permission = "perm.desmanche" }, -- CUSTOMS
	{ coords = vec3(735.42,-1072.48,22.16), range = 10.0, permission = "perm.desmanche" }, -- CUSTOMS
	{ coords = vec3(727.52,-1067.94,22.22), range = 10.0, permission = "perm.desmanche" }, -- lacoste
	{ coords = vec3(89.69,-1966.83,20.74), range = 10.0, permission = "perm.desmanche" }, -- BALLAS
	{ coords = vec3(-549.19,335.98,84.37), range = 10.0, permission = "perm.desmanche" }, -- TEQUILA
