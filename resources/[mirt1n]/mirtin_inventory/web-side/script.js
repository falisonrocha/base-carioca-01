    ...
    $.post("http://mirtin_inventory/requestMochila", JSON.stringify({}), (data) => {
        ...
        for (let x = 1; x <= mySlots; x++) {
            ...
            if (data.inventario[slot] !== undefined) {
                ...
                const item = `
                <div class="item populated" style="background-image: url('http://177.54.148.31:4020/inventario/${v.key}.png'); background-position: center; background-size: 55% !important; background-repeat: no-repeat;" data-item-key="${v.key}" data-name-key="${v.name}" data-amount="${v.amount}" data-slot="${slot}">
                    <div class="top_item">
    ...
    $.post("http://mirtin_inventory/requestVehicle", JSON.stringify({}), (data) => {
        ...
        for (let x = 1; x <= inSlots; x++) {
            ...
            if (data.inventario2[slot] !== undefined) {
                ...
                const item = `
                <div class="item populated" style="background-image: url('http://177.54.148.31:4020/inventario/${v.key}.png'); background-size: 55% !important; background-position: center; background-repeat: no-repeat;" data-item-key="${v.key}" data-name-key="${v.name}" data-amount="${v.amount}" data-slot="${slot}">
                    <div class="top_item">
                        <div class="item_amount">x${formatarNumero(v.amount)}</div>
                        <div class="item_weight">
                            <img src="images/weight.svg" alt="">
    ...
    $.post("http://mirtin_inventory/requestRevistar", JSON.stringify({}), (data) => {
        ...
        for (let x = 1; x <= inSlots; x++) {
            ...
            if (data.inventario2[slot] !== undefined) {
                ...
                const item = `
                <div class="item populated" style="background-image: url('http://177.54.148.31:4020/inventario/${v.key}.png'); background-position: center; background-repeat: no-repeat;" data-item-key="${v.key}" data-name-key="${v.name}" data-amount="${v.amount}" data-slot="${slot}">
                    <div class="top_item">
                        <div class="item_amount">x${formatarNumero(v.amount)}</div>
                        <div class="item_weight">
                            <img src="images/weight.svg" alt="">
