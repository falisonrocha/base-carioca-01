Config = {
    ...
    urlStore = 'https://baixadarj.hydrus.gg/',
    ...
    Crates = {
        ...
        ['crate_epic'] = {
            ...
            items = {
...

                {
                    ...
                    amount = 1,
                    func = function(source,user_id)
                        vRP.execute("vRP/inserir_veh",{ veiculo = 'zetorno', user_id = user_id, ipva = os.time(), expired = "{}" })
                    end
                },
        ...
        --[[['crate_cars'] = {
            ...
            items = {
                ...
                {
                    item = 'er34n',
                    name = 'Nissan Skyline R34 ‘GT-R’ Sedan',
                    type = 'car',
                    rarity = 'epic',
                    amount = 1,
                    func = function(source, user_id)
    ...
    Keys = {
        ...
        -- ['key_nuclear'] = { 
        --     name = 'Chave Caixa Nuclear', 
        --     price = 100, 
        --     category = 'comum', 
        --     image_url = 'http://177.54.148.31:4020/lotus/lotus_box/key_nuclear.png',
        --     type = 'key', 
