...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        if perm == "Coronel" and vRP.hasGroup(user_id, "Coronel") then
            ...
            vRPC.giveWeapons(source, { ["WEAPON_SPECIALCARBINE"] = {ammo= 250}, ["WEAPON_CARBINERIFLE"] = {ammo= 250}, ["WEAPON_COMBATPISTOL"] = {ammo= 250}, ["WEAPON_STUNGUN"] = {ammo=1}, ["WEAPON_FLASHLIGHT"] = {ammo=1}, ["WEAPON_NIGHTSTICK"] = {ammo=1} }, true)
            limparItems(user_id)
        ...
        elseif perm == "Primeiro Tenente" and vRP.hasGroup(user_id, "Primeiro Tenente") then
            vRPC._setCustomization(source,json.decode(consult[1].custom))
            vRP.setPatrulhamento(user_id)
            vRPC.giveWeapons(source, { ["WEAPON_SPECIALCARBINE"] = {ammo= 250}, ["WEAPON_COMBATPISTOL"] = {ammo= 250}, ["WEAPON_STUNGUN"] = {ammo=1}, ["WEAPON_FLASHLIGHT"] = {ammo=1}, ["WEAPON_NIGHTSTICK"] = {ammo=1}, ["WEAPON_CARBINERIFLE_MK2"] = {ammo=250} }, true)
            limparItems(user_id)
            vRP.giveInventoryItem(user_id, "radio", 1, true)
            TriggerEvent('eblips:add',{ name = "Policial", src = source, color = 3 })
            TriggerClientEvent("Notify",source,"sucesso","Você pegou seus equipamentos.",6000)  
        ...
        elseif perm == "Aspirante" and vRP.hasGroup(user_id, "Aspirante") then
            vRPC._setCustomization(source,json.decode(consult[1].custom))
            vRP.setPatrulhamento(user_id)
            vRPC.giveWeapons(source, { ["WEAPON_SPECIALCARBINE"] = {ammo= 250}, ["WEAPON_COMBATPISTOL"] = {ammo= 250}, ["WEAPON_STUNGUN"] = {ammo=1}, ["WEAPON_FLASHLIGHT"] = {ammo=1}, ["WEAPON_NIGHTSTICK"] = {ammo=1}, ["WEAPON_CARBINERIFLE_MK2"] = {ammo=250} }, true)
            limparItems(user_id)
        ...
        elseif perm == "Cadete" and vRP.hasGroup(user_id, "Cadete") then
            vRPC._setCustomization(source,json.decode(consult[1].custom))
            vRP.setPatrulhamento(user_id)
            vRPC.giveWeapons(source, { ["WEAPON_SPECIALCARBINE"] = {ammo= 250}, ["WEAPON_COMBATPISTOL"] = {ammo= 250}, ["WEAPON_STUNGUN"] = {ammo=1}, ["WEAPON_FLASHLIGHT"] = {ammo=1}, ["WEAPON_NIGHTSTICK"] = {ammo=1}, ["WEAPON_CARBINERIFLE_MK2"] = {ammo=250} }, true)
            limparItems(user_id)
        ...
        elseif perm == "DelegadoGeral" and vRP.hasGroup(user_id, "DelegadoGeral") then
            vRPC._setCustomization(source,json.decode(consult[1].custom))
            vRP.setPatrulhamento(user_id)
            vRPC._giveWeapons(source, { ["WEAPON_SPECIALCARBINE"] = {ammo= 250}, ["WEAPON_SPECIALCARBINE"] = {ammo= 250}, ["WEAPON_SPECIALCARBINE"] = {ammo= 250}, ["WEAPON_PISTOL_MK2"] = {ammo= 250}, ["WEAPON_STUNGUN"] = {ammo=1}, ["WEAPON_FLASHLIGHT"] = {ammo=1}, ["WEAPON_NIGHTSTICK"] = {ammo=1} }, true)
            limparItems(user_id)
            vRP.giveInventoryItem(user_id, "radio", 1, true)
        ...
        elseif perm == "Delegado" and vRP.hasGroup(user_id, "Delegado") then
            vRPC._setCustomization(source,json.decode(consult[1].custom))
            vRP.setPatrulhamento(user_id)
            vRPC._giveWeapons(source, { ["WEAPON_SPECIALCARBINE"] = {ammo= 250}, ["WEAPON_SPECIALCARBINE"] = {ammo= 250}, ["WEAPON_PISTOL_MK2"] = {ammo= 250}, ["WEAPON_STUNGUN"] = {ammo=1}, ["WEAPON_FLASHLIGHT"] = {ammo=1}, ["WEAPON_NIGHTSTICK"] = {ammo=1} }, true)
            limparItems(user_id)
            vRP.giveInventoryItem(user_id, "radio", 1, true)
            TriggerEvent('eblips:add',{ name = "PolicialCivil", src = source, color = 3 })
            TriggerClientEvent("Notify",source,"sucesso","Você pegou seus equipamentos.",6000) 
        ...
        elseif perm == "Perito" and vRP.hasGroup(user_id, "Perito") then
            vRPC._setCustomization(source,json.decode(consult[1].custom))
            vRP.setPatrulhamento(user_id)
            vRPC._giveWeapons(source, { ["WEAPON_SPECIALCARBINE"] = {ammo= 250}, ["WEAPON_CARBINERIFLE_MK2"] = {ammo= 250}, ["WEAPON_COMBATPISTOL"] = {ammo= 250}, ["WEAPON_STUNGUN"] = {ammo=1}, ["WEAPON_FLASHLIGHT"] = {ammo=1}, ["WEAPON_NIGHTSTICK"] = {ammo=1} }, true)
            limparItems(user_id)
            vRP.giveInventoryItem(user_id, "radio", 1, true)
            TriggerEvent('eblips:add',{ name = "PolicialCivil", src = source, color = 3 })
            TriggerClientEvent("Notify",source,"sucesso","Você pegou seus equipamentos.",6000) 
